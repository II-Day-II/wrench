...
namespace Wrench
{
	...
	Pipeline PipelineBuilder::build_pipeline(VkDevice device)
	{
		Pipeline ret;
	...
	PipelineBuilder& PipelineBuilder::set_shaders(VkShaderModule vtx, VkShaderModule fgmt)
	{
		m_shader_stage_infos.clear();
	...
	PipelineBuilder& PipelineBuilder::set_blending_additive()
	{
		m_color_blend_attachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
	...
	PipelineBuilder& PipelineBuilder::set_blending_alpha()
	{
		m_color_blend_attachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
		m_color_blend_attachment.blendEnable = VK_TRUE;
		m_color_blend_attachment.srcColorBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;
	...
	PipelineBuilder& PipelineBuilder::set_depth_test_off()
	{
	...
	PipelineBuilder& PipelineBuilder::set_depth_test_on(bool depth_write_enable, VkCompareOp op)
	{
